...
export default function Hero() {
  ...
  return (
    <section id="about" className="relative min-h-[78vh] flex flex-col items-center justify-center pt-28 pb-12 overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          >
            {copy.hero.descriptionStart}<span className="text-zinc-100 font-medium">{copy.hero.aiGeek}</span>
            {copy.hero.descriptionMiddle}<span className="text-zinc-100 font-medium">{copy.hero.gameCreator}</span>
            {copy.hero.descriptionBody}<span className="text-zinc-100 font-medium">{copy.hero.frontierTech}</span>
            {copy.hero.descriptionEnd}<span className="text-zinc-100 font-medium">{copy.hero.possibility}</span>
          </motion.p>
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.3em] text-zinc-600 font-medium">{copy.hero.scroll}</span>
